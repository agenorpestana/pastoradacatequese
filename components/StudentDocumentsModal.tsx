...
export const StudentDocumentsModal: React.FC<StudentDocumentsModalProps> = ({ student, onClose, onUpdateDocuments }) => {
  const [documents, setDocuments] = useState<StudentDocument[]>(student.documentos || []);
        ...
        <div className="bg-slate-900 p-8 flex justify-between items-center shrink-0">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 font-bold uppercase tracking-widest">{student.nomeCompleto}</p>
            </div>
          </div>
